...
export const metadata: Metadata = {
  title: "AI Startup | Innovative AI Solutions",
  description: "Explore cutting-edge AI technology solutions tailored for your business needs.",
  keywords: "AI, Technology, Innovation, Solutions",
  openGraph: {
    title: "AI Startup | Innovative AI Solutions",
    description: "Explore cutting-edge AI technology solutions tailored for your business needs.",
    url: "",
    siteName: "AI Startup",
    images: [{ url: "asset://heroImage" }],
    type: "website",
  },
  twitter: {
